...
/***/ (function(module, exports, __webpack_require__) {
	...
	var appEvents = __webpack_require__(13
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://floating-falls-88707.herokuapp.com',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateMood = function onCreateMood(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.createMood(data).then(ui.createMoodSuccess).catch(ui.createMoodError);
	};

	// my moods
	var onGetUserMoods = function onGetUserMoods(event) {
	  event.preventDefault();
	  api.getUserMoods().then(ui.getUserMoodsSuccess).catch(ui.getUserMoodsFailure);
	};

	var onDeleteMood = function onDeleteMood(event) {
	  event.preventDefault();
	  var moodId = $(this).attr('moodId');
	  api.deleteMood(moodId).then(ui.deleteMoodSuccess).catch(ui.deleteMoodFailure);
	};

	// edit custom moods
	var onUpdateMood = function onUpdateMood(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var moodId = $(this).attr('moodId');
	  api.updateMood(data, moodId).then(ui.updateMoodSuccess).catch(ui.updateMoodFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createMood = function createMood(data) {
	  return $.ajax({
	...
	var updateMood = function updateMood(data, moodId) {
	  return $.ajax({
	...
	var deleteMood = function deleteMood(moodId) {
	  return $.ajax({
	    url: config.apiOrigin + '/moods/' + moodId,
	    method: 'DELETE',
	    headers: {
	...
	var getUserMoods = function getUserMoods() {
	  return $.ajax({
	    url: config.apiOrigin + '/moods/',
	    method: 'GET',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var api = __webpack_require__(14);
	var showCustomMoodHB = __webpack_require__(16);

	var createMoodSuccess = function createMoodSuccess(response) {
	  api.getUserMoods().then(getUserMoodsSuccess).catch(getUserMoodsFailure);
	  var showCustomMoodHtml = showCustomMoodHB({ mood: response.mood });
	  $('#content').html(showCustomMoodHtml);
	  $('form#createMood').trigger('reset');
	  $('#content').show();
	};

	var createMoodError = function createMoodError(error) {
	  userMessage('Unable to create mood.');
	  $('#content').show();
	  $('form#createMood').trigger('reset');
	};

	var updateMoodSuccess = function updateMoodSuccess(moodTitle) {
	  api.getUserMoods().then(getUserMoodsSuccess).catch(getUserMoodsFailure);
	  $('form#createMood').trigger('reset');
	...
	var updateMoodFailure = function updateMoodFailure(error) {
	...
	var getUserMoodsSuccess = function getUserMoodsSuccess(response) {
	  var showCustomMoodsHtml = showCustomMoodHB({ moods: response.moods });
	...
	var getUserMoodsFailure = function getUserMoodsFailure() {
	  userMessage('Unable to Retrieve Data.');
	  $('form#createMood').trigger('reset');
	  $('#content').show();
	};

	var deleteMoodSuccess = function deleteMoodSuccess(moodId) {
	  api.getUserMoods().then(getUserMoodsSuccess).catch(getUserMoodsFailure);
	  $('form#createMood').trigger('reset');
	  $('#content').show();
	};

	var deleteMoodFailure = function deleteMoodFailure(moodId) {
	...
	module.exports = {
	  getUserMoodsFailure: getUserMoodsFailure,
	  getUserMoodsSuccess: getUserMoodsSuccess,
	  updateMoodFailure: updateMoodFailure,
	  updateMoodSuccess: updateMoodSuccess,
	  createMoodError: createMoodError,
	  createMoodSuccess: createMoodSuccess,
	  deleteMoodSuccess: deleteMoodSuccess,
	  deleteMoodFailure: deleteMoodFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "       <tr>\n         <!-- <td class=\"moodId\">"
	    ...
	    + "</td> -->\n         <!-- <td class=\"mood-time\">"
	    + alias2(__default(__webpack_require__(36)).call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.created_at : stack1),"MMMM Do, YYYY",{"name":"timeFormat","hash":{},"data":data,"blockParams":blockParams}))
	    + "</td> -->\n        <td class=\"mood-title\" >"
	    ...
	    + "\" moodTitle=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "\" type=\"click\" class=\"btn btn-danger btn delete-mood-button\">Delete<span class=\"glyphicon glyphicon-trash\"></span></button></td>\n      <td>\n        <form id=\"update-mood-button\" moodId=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" moodTitle=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "\">\n      <fieldset>\n        <input type=\"text\" name=\"mood[title]\" placeholder=\"Edit Mood\">\n        <input type=\"submit\" class=\"btn btn-info\" name=\"submit\" value=\"update\">\n      </fieldset>\n    </form>\n      </td>\n      </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<html>\n<table id=\"custom-mood-table\" class=\"table table-striped signed-in-view\">\n  <thead>\n    <tr>\n      <!-- <th>Id</th> -->\n      <!-- <th>Date Created</th> -->\n      <th><h4>Mood</h4></th>\n      <th><h4>Food Item</h4></th>\n    </tr>\n  </thead>\n\n<!-- add button for food -->\n\n<!-- title = mood -->\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.moods : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</table>\n</html>\n";
